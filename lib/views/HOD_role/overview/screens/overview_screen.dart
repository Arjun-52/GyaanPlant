                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          GridView.count(
                            ...
                            children: const [
                              HodStatCard(value: '2,847', label: 'Total Students', color: Colors.blue),
                              HodStatCard(value: '6', label: 'Departments', color: Colors.blue),
                              HodStatCard(value: '73%', label: 'LMS Adoption', color: Colors.green),
                              HodStatCard(value: 'A+', label: 'NAAC Grade', color: Colors.orange),
                            ],
                          ),
                        ],
                      ),
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          Row(
                            ...
                            children: const [
                              Text('Dept-wise Skill Readiness',
                                  style: TextStyle(
                                      color: Colors.white,
                                      fontWeight: FontWeight.bold)),
                          ...
                          const SizedBox(height: 20),
                          const Text('Syllabus Mapping Status',
                              style: TextStyle(
                                  color: Colors.white,
                                  fontSize: 17,
                                  fontWeight: FontWeight.bold)),
